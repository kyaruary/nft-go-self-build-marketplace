...
const TransactionBidDetails: FC<Props> = ({ token, collection, bidData }) => {
  ...
  const timeSince = useTimeSince(bidData?.expirationTime ? +bidData.expirationTime : 0);
  ...
  return (
    ...
    >
      ...
      >
        <SelectedAttribute attributeKey={bidData?.attributeKey} attributeValue={bidData?.attributeValue} />
        <Flex
          direction="column"
        ...
        >
          <Flex justify="between">
            ...
            <FormatWrappedCurrency amount={+value} textStyle="subtitle2" address={bidData?.currency} />
          </Flex>
